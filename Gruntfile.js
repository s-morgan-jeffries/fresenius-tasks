// Generated on 2015-02-02 using generator-fresenius 0.0.0
// jshint node: true
'use strict';
...
module.exports = function (grunt) {
  ...
  grunt.initConfig({
    ...
    yeoman: {
      ...
      temp: '.tmp',
      dist: 'dist',
      assets: 'node_modules/fresenius-assets/dist'
    },
...
//        plugins: ['assemble-middleware-lunr'],
        helpers: [],
        partials: ['<%= yeoman.assets %>/templates/partials/**/*.hbs'],
        layoutdir: '<%= yeoman.assets %>/templates/layouts',
        data: '<%= yeoman.src %>/data/**/*.{json,yml}',
        flatten: true
      },
      static: {
        expand: true,
        cwd: '<%= yeoman.assets %>/templates/pages',
        src: [
          './**/*.hbs'
        ],
        dest: '<%= yeoman.temp %>/'
...
//          ]
      ...
      server: {
        ...
        files: {
          '<%= yeoman.temp %>/styles/style.css': ['<%= yeoman.src %>/styles/style.styl']
        }
      },
      build: {
        options: {
